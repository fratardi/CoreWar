...
DUMP_SIZE=64			# number of bytes on one line in the dump output
# ===> end of change <=== ######################################################
...
print_usage_and_exit()
{
	...
	printf "%s\n" "     <player>      list of players to select randomly among"
	exit 1
}
